...
export function AssistantCard({ assistant, onDelete, onEdit }: AssistantCardProps) {
  ...
  return (
    <div 
      ...
      className={`group relative bg-card border rounded-xl p-5 transition-all duration-300 hover:shadow-lg flex flex-col overflow-hidden
      ${isDeleting 
    ...
    `}>
      ...
      {/* Contenido (con z-10 para estar sobre la luz) */}
